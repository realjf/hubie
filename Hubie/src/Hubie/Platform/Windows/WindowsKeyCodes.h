...
namespace Hubie
{
	namespace WindowsKeyCodes
	{
		...
		inline Hubie::InputCode::Key WindowsKeyToHubie(uint32_t key)
		{
			static std::map<uint32_t, Hubie::InputCode::Key> keyMap = {
				{ KEYBOARD_A, Hubie::InputCode::Key::A },
				{ KEYBOARD_B, Hubie::InputCode::Key::B },
				{ KEYBOARD_C, Hubie::InputCode::Key::C },
				{ KEYBOARD_D, Hubie::InputCode::Key::D },
				{ KEYBOARD_E, Hubie::InputCode::Key::E },
				{ KEYBOARD_F, Hubie::InputCode::Key::F },
				{ KEYBOARD_G, Hubie::InputCode::Key::G },
				{ KEYBOARD_H, Hubie::InputCode::Key::H },
				{ KEYBOARD_I, Hubie::InputCode::Key::I },
				{ KEYBOARD_J, Hubie::InputCode::Key::J },
				{ KEYBOARD_K, Hubie::InputCode::Key::K },
				{ KEYBOARD_L, Hubie::InputCode::Key::L },
				{ KEYBOARD_M, Hubie::InputCode::Key::M },
				{ KEYBOARD_N, Hubie::InputCode::Key::N },
				{ KEYBOARD_O, Hubie::InputCode::Key::O },
				{ KEYBOARD_P, Hubie::InputCode::Key::P },
				{ KEYBOARD_Q, Hubie::InputCode::Key::Q },
				{ KEYBOARD_R, Hubie::InputCode::Key::R },
				{ KEYBOARD_S, Hubie::InputCode::Key::S },
				{ KEYBOARD_T, Hubie::InputCode::Key::T },
				{ KEYBOARD_U, Hubie::InputCode::Key::U },
				{ KEYBOARD_V, Hubie::InputCode::Key::V },
				{ KEYBOARD_W, Hubie::InputCode::Key::W },
				{ KEYBOARD_X, Hubie::InputCode::Key::X },
				{ KEYBOARD_Y, Hubie::InputCode::Key::Y },
				{ KEYBOARD_Z, Hubie::InputCode::Key::Z },

				{ KEYBOARD_0, Hubie::InputCode::Key::D0 },
				{ KEYBOARD_1, Hubie::InputCode::Key::D1 },
				{ KEYBOARD_2, Hubie::InputCode::Key::D2 },
				{ KEYBOARD_3, Hubie::InputCode::Key::D3 },
				{ KEYBOARD_4, Hubie::InputCode::Key::D4 },
				{ KEYBOARD_5, Hubie::InputCode::Key::D5 },
				{ KEYBOARD_6, Hubie::InputCode::Key::D6 },
				{ KEYBOARD_7, Hubie::InputCode::Key::D7 },
				{ KEYBOARD_8, Hubie::InputCode::Key::D8 },
				{ KEYBOARD_9, Hubie::InputCode::Key::D9 },

				{ KEYBOARD_SUBTRACT, Hubie::InputCode::Key::Minus },
				{ KEYBOARD_DELETE, Hubie::InputCode::Key::Delete },
				{ KEYBOARD_SPACE, Hubie::InputCode::Key::Space },
				{ KEYBOARD_LEFT, Hubie::InputCode::Key::Left },
				{ KEYBOARD_RIGHT, Hubie::InputCode::Key::Right },
				{ KEYBOARD_UP, Hubie::InputCode::Key::Up },
				{ KEYBOARD_DOWN, Hubie::InputCode::Key::Down },
				{ KEYBOARD_LSHIFT, Hubie::InputCode::Key::LeftShift },
				{ KEYBOARD_RSHIFT, Hubie::InputCode::Key::RightShift },
				{ KEYBOARD_LCONTROL, Hubie::InputCode::Key::LeftControl },
				{ KEYBOARD_RCONTROL, Hubie::InputCode::Key::RightControl },
				{ KEYBOARD_LWIN, Hubie::InputCode::Key::LeftSuper },
				{ KEYBOARD_RWIN, Hubie::InputCode::Key::RightSuper },
				{ KEYBOARD_LMENU, Hubie::InputCode::Key::Menu },
				{ KEYBOARD_ESCAPE, Hubie::InputCode::Key::Escape },
				{ KEYBOARD_ADD, Hubie::InputCode::Key::Equal },
				{ KEYBOARD_BACK, Hubie::InputCode::Key::Backspace },
				{ KEYBOARD_RETURN, Hubie::InputCode::Key::Enter },
				{ KEYBOARD_COMMA, Hubie::InputCode::Key::Comma }
			};
