...
namespace Hubie::Maths
{
	...
	public:
		...
		Hubie::Maths::Matrix3 ToMatrix3() const
		{
			return Hubie::Maths::Matrix3(
				m00_,
				m01_,
				m02_,
				m10_,
		...
		bool Equals(const Matrix4& rhs, float eps = M_EPSILON) const
		{
			...
			for (unsigned i = 0; i < 16; ++i)
			{
				if (!Hubie::Maths::Equals(leftData[i], rightData[i], eps))
					return false;
			}
		...
		{
			return (
				Hubie::Maths::IsNaN(m00_) || Hubie::Maths::IsNaN(m01_) || Hubie::Maths::IsNaN(m02_) || Hubie::Maths::IsNaN(m03_) ||

				Hubie::Maths::IsNaN(m10_) || Hubie::Maths::IsNaN(m11_) || Hubie::Maths::IsNaN(m12_) || Hubie::Maths::IsNaN(m13_) ||

				Hubie::Maths::IsNaN(m20_) || Hubie::Maths::IsNaN(m21_) || Hubie::Maths::IsNaN(m22_) || Hubie::Maths::IsNaN(m23_) ||

				Hubie::Maths::IsNaN(m30_) || Hubie::Maths::IsNaN(m31_) || Hubie::Maths::IsNaN(m32_) || Hubie::Maths::IsNaN(m33_));
		}
		...
		{
			return (
				Hubie::Maths::IsInf(m00_) || Hubie::Maths::IsInf(m01_) || Hubie::Maths::IsInf(m02_) || Hubie::Maths::IsInf(m03_) ||

				Hubie::Maths::IsInf(m10_) || Hubie::Maths::IsInf(m11_) || Hubie::Maths::IsInf(m12_) || Hubie::Maths::IsInf(m13_) ||

				Hubie::Maths::IsInf(m20_) || Hubie::Maths::IsInf(m21_) || Hubie::Maths::IsInf(m22_) || Hubie::Maths::IsInf(m23_) ||

				Hubie::Maths::IsInf(m30_) || Hubie::Maths::IsInf(m31_) || Hubie::Maths::IsInf(m32_) || Hubie::Maths::IsInf(m33_));
		}
