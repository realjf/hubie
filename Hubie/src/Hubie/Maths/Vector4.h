...
namespace Hubie::Maths
{
	...
	public:
		...
		{
			return Hubie::Maths::Abs(x * rhs.x) + Hubie::Maths::Abs(y * rhs.y) + Hubie::Maths::Abs(z * rhs.z) + Hubie::Maths::Abs(w * rhs.w);
		}
		...
		Vector4 Abs() const { return Vector4(Hubie::Maths::Abs(x), Hubie::Maths::Abs(y), Hubie::Maths::Abs(z), Hubie::Maths::Abs(w)); }
		...
		{
			return Hubie::Maths::Equals(x, rhs.x, eps) && Hubie::Maths::Equals(y, rhs.y, eps) && Hubie::Maths::Equals(z, rhs.z, eps) && Hubie::Maths::Equals(w, rhs.w, eps);
		}

		/// Return whether is NaN.
		bool IsNaN() const { return Hubie::Maths::IsNaN(x) || Hubie::Maths::IsNaN(y) || Hubie::Maths::IsNaN(z) || Hubie::Maths::IsNaN(w); }
...
{
	template <>
	struct hash<Hubie::Maths::Vector4>
	{
		size_t operator()(const Hubie::Maths::Vector4& x) const noexcept
		{
