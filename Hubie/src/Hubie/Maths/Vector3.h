...
namespace Hubie::Maths
{
	...
	public:
		...
		void Normalise()
		{
			...
			if (!Hubie::Maths::Equals(lenSquared, 1.0f) && lenSquared > 0.0f)
			{
		...
		{
			return Hubie::Maths::Abs(x * rhs.x) + Hubie::Maths::Abs(y * rhs.y) + Hubie::Maths::Abs(z * rhs.z);
		}
		...
		Vector3 Abs() const { return Vector3(Hubie::Maths::Abs(x), Hubie::Maths::Abs(y), Hubie::Maths::Abs(z)); }
		...
		{
			return Hubie::Maths::Equals(x, rhs.x, eps) && Hubie::Maths::Equals(y, rhs.y, eps) && Hubie::Maths::Equals(z, rhs.z, eps);
		}

		/// Returns the angle between this vector and another vector in degrees.
		float Angle(const Vector3& rhs) const { return Hubie::Maths::Acos(DotProduct(rhs) / (Length() * rhs.Length())); }

		/// Return whether is NaN.
		bool IsNaN() const { return Hubie::Maths::IsNaN(x) || Hubie::Maths::IsNaN(y) || Hubie::Maths::IsNaN(z); }

		/// Return whether is Inf.
		bool IsInf() const { return Hubie::Maths::IsInf(x) || Hubie::Maths::IsInf(y) || Hubie::Maths::IsInf(z); }
...
{
	template <>
	struct hash<Hubie::Maths::Vector3>
	{
		size_t operator()(const Hubie::Maths::Vector3& x) const
		{
