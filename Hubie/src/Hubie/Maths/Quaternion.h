...
namespace Hubie::Maths
{
	...
	public:
...
#if defined(HB_SSE) && (!defined(_MSC_VER) || _MSC_VER >= 1700) /* Visual Studio 2012 and newer. VS2010 bug */
		{
		...
		{
			return Hubie::Maths::Equals(w, rhs.w, eps) && Hubie::Maths::Equals(x, rhs.x, eps) && Hubie::Maths::Equals(y, rhs.y, eps) && Hubie::Maths::Equals(z, rhs.z, eps);
		}

		/// Return whether any element is NaN.
		bool IsNaN() const { return Hubie::Maths::IsNaN(w) || Hubie::Maths::IsNaN(x) || Hubie::Maths::IsNaN(y) || Hubie::Maths::IsNaN(z); }

		/// Return whether any element is Inf.
		bool IsInf() const { return Hubie::Maths::IsInf(w) || Hubie::Maths::IsInf(x) || Hubie::Maths::IsInf(y) || Hubie::Maths::IsInf(z); }
