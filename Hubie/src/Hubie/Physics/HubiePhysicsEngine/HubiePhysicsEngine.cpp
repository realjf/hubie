...
#include "Hubie/Scene/Component/Physics3DComponent.h"
...
namespace Hubie
{
    ...
    float HubiePhysicsEngine::s_UpdateTimestep = 1.0f / 60.0f;

    HubiePhysicsEngine::HubiePhysicsEngine()
        : m_IsPaused(true)
        , m_UpdateAccum(0.0f)
    ...
    void HubiePhysicsEngine::OnUpdate(const TimeStep& timeStep, Scene* scene)
    {
        HB_PROFILE_FUNCTION();
        m_RigidBodys.clear();
        ...
        if(!m_IsPaused)
        {
            ...
            {
                HB_PROFILE_SCOPE("Physics::Get Rigid Bodies");
            ...
            {
                HB_PROFILE_SCOPE("Physics::Get Spring Constraints");
                m_Constraints.clear();
            ...
            {
                HB_PROFILE_SCOPE("Physics::Get Axis Constraints");
            ...
            {
                HB_PROFILE_SCOPE("Physics::Get Distance Constraints");
            ...
            {
                HB_PROFILE_SCOPE("Physics::Get Weld Constraints");
            ...
            {
                HB_PROFILE_SCOPE("Physics::UpdatePhysics");
                if(m_MultipleUpdates)
                {
                    ...
                    {
                        HB_WARN("Physics too slow to run in real time!");
            ...
            {
                HB_PROFILE_SCOPE("Physics::Set Transforms");
    ...
    void HubiePhysicsEngine::UpdatePhysics()
    {
        m_Manifolds.clear();
    ...
    void HubiePhysicsEngine::UpdateRigidBodys()
    {
#ifdef THREAD_RIGID_BODY_UPDATE
        HB_PROFILE_SCOPE("Thread Update Rigid Body");
...
#else
        HB_PROFILE_SCOPE("Update Rigid Body");
    ...
    void HubiePhysicsEngine::UpdateRigidBody(RigidBody3D* obj) const
    {
        HB_PROFILE_FUNCTION();
    ...
    void HubiePhysicsEngine::BroadPhaseCollisions()
    {
        HB_PROFILE_FUNCTION();
    ...
    void HubiePhysicsEngine::NarrowPhaseCollisions()
    {
        HB_PROFILE_FUNCTION();
    ...
    void HubiePhysicsEngine::SolveConstraints()
    {
        HB_PROFILE_FUNCTION();

        {
            HB_PROFILE_SCOPE("Solve Manifolds");

            for(Manifold& m : m_Manifolds)
                m.PreSolverStep(s_UpdateTimestep);
        }
        {
            HB_PROFILE_SCOPE("Solve Constraints");
        ...
        {
            HB_PROFILE_SCOPE("Apply Impulses");
    ...
    void HubiePhysicsEngine::ClearConstraints()
    {
        m_Constraints.clear();
    }
    ...
    void HubiePhysicsEngine::OnImGui()
    {
        HB_PROFILE_FUNCTION();
    ...
    void HubiePhysicsEngine::OnDebugDraw()
    {
        HB_PROFILE_FUNCTION();
