...
namespace Hubie
{
        ...
        std::vector<CollisionPair>& collisionPairs)
    {
        ...
        for(uint32_t i = 0; i < objectCount; i++)
        {
            ...
            {
                HB_PROFILE_SCOPE("Merge Bounding box and add Physics Object");
    ...
    void OctreeBroadphase::Divide(OctreeNode& division, const size_t iteration)
    {
        ...
        for(size_t i = 0; i < NUM_DIVISIONS; i++)
        {
            ...
            {
                HB_PROFILE_SCOPE("PhysicsObject BB check");
