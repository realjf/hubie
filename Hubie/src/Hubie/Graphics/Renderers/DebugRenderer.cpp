...
#include "Hubie/Graphics/Renderers/LineRenderer.h"
#include "Hubie/Graphics/Renderers/PointRenderer.h"
...
#define RENDERER_BUFFER_SIZE RENDERER_LINE_SIZE* MaxLineVertices
    ...
    {
        Hubie::DebugRenderer::DrawPointNDT(sphere.center_, sphere.radius_, colour);
    }
