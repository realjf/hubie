...
namespace Hubie
{
    ...
    namespace Graphics
    {
        ...
        class HB_EXPORT ShadowRenderer : public IRenderer
        {
        public:
            ...
            {
                Hubie::Maths::Matrix4 projView[SHADOWMAP_MAX];
            };
            ...
            const Hubie::Maths::Matrix4& GetLightView() const { return m_LightMatrix; }
        ...
        protected:
            ...
            Hubie::Graphics::UniformBuffer* m_UniformBuffer;
