...
namespace Hubie
{
	namespace Graphics
	{
		...
		class HB_EXPORT Texture2D : public Texture
		{
		public:
		...
		class HB_EXPORT TextureCube : public Texture
		{
		protected:
		...
		class HB_EXPORT TextureDepth : public Texture
		{
		public:
		...
		class HB_EXPORT TextureDepthArray : public Texture
		{
		public:
